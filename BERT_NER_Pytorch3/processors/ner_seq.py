...
def collate_fn(batch):
    ...
    """
    all_input_ids, all_attention_mask, all_token_type_ids, all_lens, all_labels, all_texts = map(torch.stack,
                                                                                                 zip(*batch))
    ...
    return all_input_ids, all_attention_mask, all_token_type_ids, all_labels, all_lens, all_texts


def collate_fn_crf(batch):
    """
    batch should be a list of (sequence, target, length) tuples...
    Returns a padded tensor of sequences sorted from longest to shortest,
    """
