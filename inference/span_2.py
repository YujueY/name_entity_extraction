...
class GeneralModelSpanPredict():
    def __init__(self, checkpoint, max_seq_length):
        ...
        self.label_list = ["O", '逾期付款违约金计算基数', '违约金计算周期', '违约金利率']
...
if __name__ == "__main__":
    max_seq_length = 512
    checkpoint = "./models/chinese_roberta_L-4_H-512_span_违约金相关+_v5"
    # checkpoint='/app_name/nlp/azun/second_phase_extrction/models/chinese_roberta_L-4_H-512_span_违约金相关+_v5'
